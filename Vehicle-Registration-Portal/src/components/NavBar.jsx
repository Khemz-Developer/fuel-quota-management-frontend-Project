  ...
  const navItems = (
    <>
      <li>
        <Link
          to="/"
          className={`text-black ${isActive("/") ? "text-[#176B87]" : ""}`}
        >
          Home
        </Link>
      </li>
      <li>
        <Link
          to="/registration"
          className={`text-black ${isActive("/registration") ? "text-[#176B87]" : ""}`}
        >
          Register Vehicle
        </Link>
      </li>
      <li>
        <Link
          to="/dashboard"
          className={`text-black ${isActive("/dashboard") ? "text-[#176B87]" : ""}`}
        >
          Dashboard
        </Link>
      </li>
      <li>
        <Link
          to="/help"
          className={`text-black ${isActive("/help") ? "text-[#176B87]" : ""}`}
        >
          Help & Support
        </Link>
      </li>
